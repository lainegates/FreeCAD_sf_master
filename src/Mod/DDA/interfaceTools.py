...
#        result.append((self.left , maxY , self.zValue))
#        result.append((minX , maxY , self.zValue))
#        result.append((minX , minY , self.zValue))
#        result.append((maxX , minY , self.zValue))
#        result.append((maxX , maxY , self.zValue))
#        result.append((self.right , maxY , self.zValue))
